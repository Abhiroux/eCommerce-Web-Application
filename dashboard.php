...
<body>
    ...
    <div class="container-fluid">
        ...
        <section id="hero" class="d-flex flex-column align-items-start justify-content-center text-white p-5">
            <h4 class="pb-1 text-dark">New Arrivals</h4>
        ...
        <section id="features" class="d-flex justify-content-around align-items-center flex-wrap mb-4">
            <div class="f-box">
                <img src="Backend/Images/features/f1.png" alt="Free shipping" width="100%" />
                <h6>Free shipping</h6>
            </div>
            <div class="f-box">
                <img src="Backend/Images/features/f2.png" alt="Online Order" width="100%" />
                <h6>Online Order</h6>
            </div>
            <div class="f-box">
                <img src="Backend/Images/features/f3.png" alt="Save Money" width="100%" />
                <h6>Save Money</h6>
            </div>
            <div class="f-box">
                <img src="Backend/Images/features/f4.png" alt="Promotions" width="100%" />
                <h6>Promotions</h6>
            </div>
            <div class="f-box">
                <img src="Backend/Images/features/f5.png" alt="Happy Sell" width="100%" />
                <h6>Happy Sell</h6>
            </div>
            <div class="f-box">
                <img src="Backend/Images/features/f6.png" alt="24x7 Support" width="100%" />
                <h6>24x7 Support</h6>
            </div>
        </section>
        ...
        <section id="product-list" class="d-flex flex-row flex-wrap row">
        </section>
